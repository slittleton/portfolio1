...
const About = () => {
  return (
    <div className="about">
      <div className="top">
        <div className="top-container flx">
          ...
          <div className="right-side">
            ...
            <div className="text">
              ...
              assumenda libero natus accusantium enim temporibus ducimus! Eius,
              et at? Sapiente et odio id dolorum aspernatur asperiores deleniti
              voluptatibus corrupti officia quaerat? Placeat totam, sed cumque
              quos deleniti, ratione, aut illum ullam esse in nesciunt
              distinctio rerum vero cum ipsam! Eaque, veniam rerum at nihil
              perspiciatis voluptatibus eveniet quibusdam Similique.
            </div>
          </div>
        </div>
      </div>
